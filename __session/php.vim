...
let Lf_Mru_StlResultsCount = "100"
let Lf_DelimiterChar = ";"
let UltiSnipsRemoveSelectModeMappings =  1 
let Lf_File_StlTotal = "56024"
...
let Lf_Debug_Cmd = "rg --no-messages --files --color never  -g '!.git' -g '!node_modules'  --hidden  "
...
let Lf_Mru_StlCwd = "/iwork/project/php/7.4/geek"
...
let Lf_File_StlResultsCount = "5611"
...
let Lf_File_StlCwd = "/iwork/project/php"
...
silent only
silent tabonly
cd /iwork/project/php/7.0/collage_new
...
tabnew
tabrewind
edit /iwork/project/php/7.4/geek/app/Api/Controllers/V1/Equity.php
argglobal
balt application/api/controller/User.php
let s:cpo_save=&cpo
set cpo&vim
...
setlocal tagcase=
setlocal tagfunc=
setlocal tags=/iwork/project/php/7.4/geek/tags,./.tags;,.tags,tags
set termwinkey=<c-_>
...
43
normal! zo
let s:l = 62 - ((9 * winheight(0) + 21) / 42)
...
normal! 0
tabnext
edit application/api/controller/User.php
argglobal
balt /iwork/project/php/7.4/geek/app/Api/Controllers/V1/Equity.php
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <expr> <C-R> peekaboo#peek(1, "\",  0)
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
setlocal tagcase=
setlocal tagfunc=
setlocal tags=/iwork/project/php/7.0/collage_new/tags,./.tags;,.tags,tags
set termwinkey=<c-_>
setlocal termwinkey=<c-_>
setlocal termwinscroll=10000
setlocal termwinsize=
...
2544
normal! zo
let s:l = 2572 - ((9 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 2572
normal! $
tabnext 2
badd +62 /iwork/project/php/7.4/geek/app/Api/Controllers/V1/Equity.php
badd +1 application/api/controller/User.php
